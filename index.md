...
<b>Safe & Robust ML</b>: The need for ML systems that are both intrinsically safe and universally robust is evident. Safety entils model's ability to recognize and defer uncertain decisions. Robustness emphasizes the model's resilience against adversarial attacks, unanticipated scenarios, and data inconsistencies. My research endeavors include techniques such as uncertainty estimation, calibration, and Out-of-Distribution detection to enhence the safety and robustness of ML systems. Relevant publications are listed below: <br>
* Threshold-Based Auto-Labeling: <a href="https://arxiv.org/abs/2211.12620">[HaLin2023] <br>
* Human-in-the-Loop Out-of-Distribution Detection: <a href="https://drive.google.com/file/d/15HKqge8mfjgapdw6knGMEMEDflsKHlvP/view">[HaLin2022]</a>, <a href="">[HaLin2022]</a> <br>
